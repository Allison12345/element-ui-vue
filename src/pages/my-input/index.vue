<template lang="pug">
  page
    el-input.w-36(placeholder="请输入内容" v-model="input1" clearable)
    el-input(placeholder="请输入内容" v-model="input2" show-password)
    el-input(placeholder="请输入内容" v-model="input3"  suffix-icon="el-icon-date")
...
const componentList = [Input, Autocomplete]
